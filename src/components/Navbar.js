        ...
        <Wrap extendClassName={styles.wrapExtendForNav}>
            ...
            {windowWidth < 1280 && (
                <button type="button" onClick={toggleNavbar}>
                    <FontAwesomeIcon icon={isActive ? faClose : faBars} className={styles.burgerMenu} />
                </button>
            )}
            <nav className={`${styles.nav} ${windowWidth >= 1280 ?
                ...
                <div className={styles.socialHolder}>
                    <a onClick={() => windowWidth < 1280 && toggleNavbar()} href="https://www.linkedin.com/in/andrej-stjepanovic/" target="_blank" rel="noreferrer"><FontAwesomeIcon icon={faLinkedin} className={styles.socialIcon} /></a>
                    <a onClick={() => windowWidth < 1280 && toggleNavbar()} href="https://github.com/stjepanoviccc" target="_blank" rel="noreferrer"><FontAwesomeIcon icon={faGithub} className={styles.socialIcon} /></a>
                    <a onClick={() => windowWidth < 1280 && toggleNavbar()} href="https://www.instagram.com/andrejstjepanovicc/" target="_blank" rel="noreferrer"><FontAwesomeIcon icon={faInstagram} className={styles.socialIcon} /></a>
                </div>
            </nav>
        </Wrap>
    )
